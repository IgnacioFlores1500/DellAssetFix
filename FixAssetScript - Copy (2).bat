...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
rem removes spaces from CleanSerial
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

If Exist "cleanSerial.txt" (For /F Delims^=^ EOL^= %%A In ('More /T1 "cleanSerial.txt"')Do @Set "$=%%A"&Call Echo(%%$: =%%)>"noSpaceSerial.txt"
set "noSpaceSerial=noSpaceSerial.txt"


:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
rem Set spaces to separate values
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
set "spaces=|" 
(
	echo  !spaces!   
...
FOR /F "tokens=*" %%i IN (%noSpaceSerial%) DO (
	REM set "string=%%i"
...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
powershell -noprofile -command "&{ start-process powershell -ArgumentList '-noprofile -file C:\Users\cblick\Desktop\KaceAssetfix\Script.ps1' -verb RunAs}"
